...
student_data(student_id="21102001")
student_data(student_id="21102001",student_name="Maninder")
student_data(student_id="21102001",student_name="Maninder",student_class="1st Year")
print()
